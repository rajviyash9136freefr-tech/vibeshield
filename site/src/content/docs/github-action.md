---
title: GitHub Action
description: "vibeshield/action@v2.0.0 — inputs, outputs, gate modes, PR comments, and the badge. The security gate for AI-generated pull requests."
order: 2
---

`vibeshield/action@v2.0.0` is a composite GitHub Action that scans your PR diff and
...
| `version` | `v2.0.0` | Pinned scanner release tag to download. |
