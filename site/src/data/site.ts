  ...
  cols: [
    {
      ...
      links: [
        ...
        ['Live Audit Demo', '/#scanner'],
        ['CLI Install Guide', '/install'],
        ['FAQ', '/#faq'],
      ] as [string, string][],
    },
    {
      ...
      links: [
        ...
        ['GitHub Action Gate', '/docs/github-action'],
        ['Pre-commit Hook', '/docs/pre-commit'],
    ...
    },
    {
      ...
      links: [
        ['Blog & Research', '/blog'],
        ['Slopsquatting Report', '/blog/slopsquatting-explained'],
        ['Changelog & Releases', '/changelog'],
        ['Bug-Hunting Skill', '/docs/skill'],
        ['Upgrading to v3', '/docs/migration-v3'],
      ] as [string, string][],
    },
    {
      title: 'Trust & Legal',
